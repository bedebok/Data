...
|-------+--------------+-------------------------------------------+----------+--------|
| 1v    | MINIATURE    |                                           |          |        |
| 13r   | OFFICE_START | SEVEN_PSALMS                              |          |        |
| 13r   | RUBRIC       | Hir begynne(n) soue(n) salme(n)           | MLG      | meta   |
|       | PRAYER_START | SEVEN_PSALMS_1                            |          |        |
| 13r   | INCIPIT      | [[3][D]]omine ne in furo(r)e tuo                 | LAT      | meta   |
| 13r   | INCIPIT      | Here en schelt my nicht in dyneme vmmode  | MLG      | main   |
|       | EXPLICIT     | vnde deme hilgen geyste. Amen.            | MLG      | main   |
|       | PRAYER_START | SEVEN_PSALMS_2                            |          |        |
|       | RUBRIC       | Ps(almus)                                 | LAT      | meta   |
|       | INCIPIT      | Beati quo...                              |          |        |
|       | INCIPIT      | Salich sint de den ere bosheyt is vorgeue |          |        |
|       | EXPLICIT     | vnde deme hilgen geyste                   |          |        |
|       |              |                                           |          |        |
* Bibliography
